 ...
 * </div>
 */
- (FMIceLinkAction1<FMIceLinkWebSync4LeaveConferenceFailureArgs*>*) onFailure;
/*!
 * <div>
 * Gets the callback to invoke if the request succeeds.
 * </div>
 */
- (FMIceLinkAction1<FMIceLinkWebSync4LeaveConferenceSuccessArgs*>*) onSuccess;
/*!
 * <div>
 * Sets the conference channel.
 * </div>
 ...
 * </div>
 */
- (void) setOnFailure:(FMIceLinkAction1<FMIceLinkWebSync4LeaveConferenceFailureArgs*>*)value;
/*!
 * <div>
 * Sets the callback to invoke if the request fails.
 * </div>
 ...
 * </div>
 */
- (void) setOnSuccess:(FMIceLinkAction1<FMIceLinkWebSync4LeaveConferenceSuccessArgs*>*)value;
/*!
 * <div>
 * Sets the callback to invoke if the request succeeds.
 * </div>
 ...
 * </div>
 */
- (NSMutableDictionary<NSString*,FMWebSyncRecord*>*) boundRecords;
/*!
 * <div>
 ...
 */
- (instancetype) initWithInstanceId:(NSString*)instanceId boundRecords:(NSMutableDictionary<NSString*,FMWebSyncRecord*>*)boundRecords;
/*!
 * <div>
 ...
 * @param boundRecords The WebSync bound records.
 */
+ (FMIceLinkWebSync4PeerClient*) peerClientWithInstanceId:(NSString*)instanceId boundRecords:(NSMutableDictionary<NSString*,FMWebSyncRecord*>*)boundRecords;
/*!
 * <div>
 * Sets the WebSync bound records.
 * </div>
 */
- (void) setBoundRecords:(NSMutableDictionary<NSString*,FMWebSyncRecord*>*)value;
/*!
 * <div>
